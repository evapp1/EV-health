...
The production Android application ID is `com.evhealth.app`. Development and QA flavor identifiers will be configured by their dedicated implementation task.
